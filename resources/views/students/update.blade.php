  ...
  <div class="container form-container">
    ...
    <form action="/update-student/{{$data->id}}" method="POST" enctype="multipart/form-data" >
      ...
      <div class="mb-3">
        ...
        <input type="tel" class="form-control" name="mobile" value="{{ $data->mobile }}" pattern="[0-9]{10}" required />
        
      </div>
      <div class="mb-3">
        <label class="form-label">Father's Name</label>
        <input type="text" class="form-control" value="{{ $data->father }}" name="father" required />
      ...
      <div class="row mb-3">
        ...
        <div class="col">
          <label class="form-label">District</label>
           <input type="text" class="form-control" name="district" value="{{ $data->district }}" required />
      ...
      <div class="d-flex justify-content-center"><a href="{{ URL::to('/list') }}" class="text-white">back</a></div>
    </form>
  </div>
